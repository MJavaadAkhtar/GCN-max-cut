...
nx_generated_graph = {}
terminals = {}
list_nodes = [[40,100], [101, 200], [200, 300], [700, 800], [800, 900], [900,999]]
for (start, end) in list_nodes:
    for i in range (0, 13, 1):
        nodes = random.randint(start,end)
        ...
        unique_random_numbers = generate_unique_random_numbers(nodes-1)

        nx_generated_graph[i] = nx_graph
        terminals[i] = unique_random_numbers
    ds = createGraphFromFolder_full(nx_generated_graph, terminals, 1000)
    save_object(ds, f'nx_test_generated_graph_n{start}_{end}_d8_12_t500.pkl')
    terminals={}
    nx_generated_graph = {}

# nx_graph = generate_graph(n=6111, d=12, p=None, graph_type='reg', random_seed=2)
# for u, v, d in nx_graph.edges(data=True):
#     d['weight'] = 1
#     d['capacity'] = 1
# unique_random_numbers = generate_unique_random_numbers(6111)
# nx_generated_graph[0] = nx_graph
# terminals[0] = unique_random_numbers
